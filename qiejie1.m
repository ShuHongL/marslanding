...
dim = 2;                          % 空间维数
ger = 200;                       % 最大迭代次数     
xlimit_max = [50000,0];    % 设置位置参数限制(矩阵的形式可以多维)-自变量取值范围
...
for i=1:sizepop
    fitness_gbest(i)=huoxing1(pop_x(1,i),pop_x(2,i)); % 每个个体的历史最佳适应度
end
...
%         fitness_pop = huoixng02(pop_x(1,:),pop_x(2,:));                      % 当前个体的适应度
            for i=1:sizepop
                fitness_pop(i)=huoxing1(pop_x(1,i),pop_x(2,i)); % 每个个体的历史最佳适应度
            end
